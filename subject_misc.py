# These are UTME Subject

core_Subject = ['Use of English', 'Mathematic']
core_science_subject = ['Physic']
elective_subject = ['Biology', 'Chemistry', 'Agricultural Science', 'Economics', 'Geography']

# These are Olevel Subject

science_subject = ['Physics', 'Chemistry']
